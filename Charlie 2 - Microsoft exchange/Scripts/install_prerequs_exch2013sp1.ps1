...
ECHO "Installing Windows feature RSAT-ADDS" 

Install-WindowsFeature RSAT-ADDS

ECHO "Done installing RSAT-ADDS"

ECHO "Installing OS roles and features and Installing NET-Framework-45-Features"
...
ISAPI-Filter, Web-Lgcy-Mgmt-Console, Web-Metabase, Web-Mgmt-Console, Web-
Mgmt-Service, Web-Net-Ext45, Web-Request-Monitor, Web-Server, Web-Stat-
Compression, Web-Static-Content, Web-Windows-Auth, Web-WMI, Windows-Identity-
Foundation
